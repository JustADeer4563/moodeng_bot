...
@bot.tree.command(name="stock", description="เช็คเมล็ดที่ขายในgrow a garden")
async def stockcommand(interaction):
    await interaction.response.send_message("/get_seeds")
...
async def helpcommand(interaction):
    ...
    emmbed.add_field(name="/stock", value="Stock Command", inline=False)
    emmbed.add_field(name="/stock", value="Stock Command", inline=False)
